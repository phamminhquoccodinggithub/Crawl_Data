...
headers = {
    ...
    'Referer': 'https://tiki.vn/giay-boots-nam/c8337',
...
params = {
    ...
    'trackity_id': '28acd1c9-ee44-9723-156a-5b393e3be1f6',
    'category': '8337',
    'page': '1',
    'urlKey': 'giay-boots-nam'
}
...
df.to_csv('tiki_product_id.csv', index=False)
